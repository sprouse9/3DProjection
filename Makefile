#############################################################################
# Makefile for building: 3Dto2DProjection.app/Contents/MacOS/3Dto2DProjection
# Generated by qmake (3.0) (Qt 5.7.0)
# Project:  3Dto2DProjection.pro
# Template: app
# Command: /Users/randy/Qt/5.7/clang_64/bin/qmake -spec macx-clang CONFIG+=debug CONFIG+=x86_64 CONFIG+=qml_debug -o Makefile 3Dto2DProjection.pro
#############################################################################
...
INCPATH       = -I. -I../../../Qt/5.7/clang_64/lib/QtWidgets.framework/Headers -I../../../Qt/5.7/clang_64/lib/QtGui.framework/Headers -I../../../Qt/5.7/clang_64/lib/QtCore.framework/Headers -I. -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.12.sdk/System/Library/Frameworks/OpenGL.framework/Headers -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.12.sdk/System/Library/Frameworks/AGL.framework/Headers -I../../../Qt/5.7/clang_64/mkspecs/macx-clang -F/Users/randy/Qt/5.7/clang_64/lib
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = 3Dto2DProjection1.0.0
DISTDIR = /Users/randy/Documents/QtDev/3Dto2DProjection/.tmp/3Dto2DProjection1.0.0
...
DESTDIR       = 
TARGET        = 3Dto2DProjection.app/Contents/MacOS/3Dto2DProjection
...
$(TARGET):  $(OBJECTS)  
	@test -d 3Dto2DProjection.app/Contents/MacOS/ || mkdir -p 3Dto2DProjection.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: 3Dto2DProjection.pro ../../../Qt/5.7/clang_64/mkspecs/macx-clang/qmake.conf ../../../Qt/5.7/clang_64/mkspecs/features/spec_pre.prf \
		../../../Qt/5.7/clang_64/mkspecs/qdevice.pri \
		../../../Qt/5.7/clang_64/mkspecs/features/device_config.prf \
		../../../Qt/5.7/clang_64/mkspecs/common/unix.conf \
		../../../Qt/5.7/clang_64/mkspecs/common/mac.conf \
	...
	$(QMAKE) -spec macx-clang CONFIG+=debug CONFIG+=x86_64 CONFIG+=qml_debug -o Makefile 3Dto2DProjection.pro
...
3Dto2DProjection.app/Contents/PkgInfo: 
	@test -d 3Dto2DProjection.app/Contents || mkdir -p 3Dto2DProjection.app/Contents
	@$(DEL_FILE) 3Dto2DProjection.app/Contents/PkgInfo
	@echo "APPL????" > 3Dto2DProjection.app/Contents/PkgInfo
3Dto2DProjection.app/Contents/Resources/empty.lproj: 
	@test -d 3Dto2DProjection.app/Contents/Resources || mkdir -p 3Dto2DProjection.app/Contents/Resources
	@touch 3Dto2DProjection.app/Contents/Resources/empty.lproj
	
3Dto2DProjection.app/Contents/Info.plist: 
	@test -d 3Dto2DProjection.app/Contents || mkdir -p 3Dto2DProjection.app/Contents
	@$(DEL_FILE) 3Dto2DProjection.app/Contents/Info.plist
	@sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,@BUNDLEIDENTIFIER@,sprouse.3Dto2DProjection,g" -e "s,@ICON@,,g" -e "s,@EXECUTABLE@,3Dto2DProjection,g" -e "s,@LIBRARY@,3Dto2DProjection,g" -e "s,@TYPEINFO@,????,g" ../../../Qt/5.7/clang_64/mkspecs/macx-clang/Info.plist.app >3Dto2DProjection.app/Contents/Info.plist

all: Makefile \
		3Dto2DProjection.app/Contents/PkgInfo \
		3Dto2DProjection.app/Contents/Resources/empty.lproj \
		3Dto2DProjection.app/Contents/Info.plist $(TARGET)
...
distclean: clean 
	-$(DEL_FILE) -r 3Dto2DProjection.app
...
compiler_rcc_clean:
compiler_moc_header_make_all: moc_canvaswidget.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_canvaswidget.cpp
moc_canvaswidget.cpp: ../../../Qt/5.7/clang_64/lib/QtWidgets.framework/Headers/QWidget \
...
main.o: main.cpp canvaswidget.h \
...
canvaswidget.o: canvaswidget.cpp canvaswidget.h \
		../../../Qt/5.7/clang_64/lib/QtWidgets.framework/Headers/QWidget \
		../../../Qt/5.7/clang_64/lib/QtWidgets.framework/Headers/qwidget.h \
		../../../Qt/5.7/clang_64/lib/QtGui.framework/Headers/QPainter \
		../../../Qt/5.7/clang_64/lib/QtGui.framework/Headers/qpainter.h \
